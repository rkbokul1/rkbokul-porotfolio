        ...
        <div id="skill" className="mt-5 text-accent">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 px-12 text-white">
                ...
                <div className='card shadow-2xl p-10 m-3'>
                    ...
                    <div className="grid grid-col-1 md:grid-cols-2 items-center gap-5 pb-5">
                        {expertise.map((skill) => (
                ...
                <div className='card shadow-2xl p-10 m-3'>
                    <h2 className="text-2xl font-bold mb-5 text-primary">Comfortable</h2>
                    <div className="grid grid-col-1 md:grid-cols-2 items-center gap-5 pb-5">
                ...
                <div className='card shadow-2xl p-10 m-3'>
                    <h2 className="text-2xl font-bold mb-5 text-primary">Familiar</h2>
                    <div className="grid grid-col-1 md:grid-cols-2 items-center gap-5 pb-5">
                        {familiar.map((skill) => (
                            <SkillCard key={skill.id} skill={skill} />
                        ))}
                ...
                <div className='card shadow-2xl p-10 m-3'>
                    <h2 className="text-2xl font-bold mb-5 text-primary">Tools</h2>
                    <div className="grid grid-col-1 md:grid-cols-2 items-center gap-5 pb-5">
                        {tools.map((skill) => (
                            <SkillCard key={skill.id} skill={skill} />
                        ))}
